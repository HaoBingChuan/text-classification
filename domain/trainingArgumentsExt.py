...
class TrainingArgumentsExt:
    """
    拷贝自类 paddlenlp.trainer.TrainingArguments，为了给属性(output_dir)追加default值。comment by zengtao.2023.05.10
    ...
    device: Optional[str] = field(default=DEVICE, metadata={"help": "select cpu, gpu, xpu devices."})
    ...
    def __post_init__(self):
        ...
        if self.report_to == "all" or self.report_to == ["all"]:
            ...
            from paddlenlp.trainer.integrations import get_available_reporting_integrations
