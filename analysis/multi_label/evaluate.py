...
parser.add_argument('--device', default=DEVICE, help="Select which device to evaluate model, defaults to gpu.")
parser.add_argument("--dataset_dir", required=True, type=str, help="Local dataset directory should include dev.txt and label.txt")
parser.add_argument("--params_path", default="checkpoint/multi_label", type=str, help="The path to model parameters to be loaded.")
